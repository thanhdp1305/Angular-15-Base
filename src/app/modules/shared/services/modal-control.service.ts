...
export class ModalControl {
  ...
  show(params: BaseModal.BaseModalOptions): NgbModalRef | void {
    const modalRef = this.ngbModal.open(ModalTemplateComponent, { centered: true, ...params?.ngbModalConfig });
    ...
    modalRef.componentInstance.callback2 = params?.confirmButton?.callback || null;
  }
