export const REGEXP_EMAIL = new RegExp(/^[a-z0-9]+(?:(?!.*\.\.)[._@-]+[a-z0-9]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])*$/);
...
export const REGEXP_USERNAME = new RegExp(/^[a-z0-9]+(?:(?!.*\.\.)[._@-]+[a-z0-9]+)*(@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9]))*$/);
